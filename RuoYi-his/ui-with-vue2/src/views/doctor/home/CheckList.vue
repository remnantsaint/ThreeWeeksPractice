...
<script>
import {  getCheck_item, delCheck_item, addCheck_item, updateCheck_item } from "@/api/commondata/check_item";
import { listCheck_item, } from "@/api/doctor/doctor";
...
export default {
  ...
  methods: {
    ...
    selectCheck(){
      //
      this.$emit("selectCheck",this.selection)
